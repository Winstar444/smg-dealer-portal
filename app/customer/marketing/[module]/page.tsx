...
> = {
  "new-campaign": {
    description: "View and launch new marketing campaigns and promotional offers.",
    sections: [
      ...
      { title: "Campaign Records", description: "Data table of all campaigns (Coming Soon)" },
    ],
  },
  "budget-approval": {
    description: "Request and manage marketing budget approvals for campaigns.",
    sections: [
      { title: "Budget Overview" },
      { title: "Approval Requests", description: "Pending budget requests" },
      { title: "Budget History", description: "Data table of approvals (Coming Soon)" },
    ],
  },
  companies: {
    description: "Directory of marketing partner companies and agencies.",
    sections: [
      { title: "Partner Directory" },
      { title: "Company Profiles", description: "Detailed information on partners" },
      { title: "Company List", description: "Data table of marketing companies (Coming Soon)" },
    ],
  },
}
...
export default function CustomerMarketingPage() {
  ...
  const moduleData = CUSTOMER_SECTIONS.marketing.find((m) => m.id === module)
  const content = MARKETING_CONTENT[module] || { description: "Marketing module details", sections: [] }
